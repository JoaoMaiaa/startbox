          ...
          <S.Box position="absolute" top="0" >
            <S.Box display="flex" height="100vh" alignItems="center">
              <S.Box data-aos="fade-right">
                ...
                <S.Text padding="0 4rem 0 0" margin="10px 0 8px">
                  We are a web development startup we are ready to serve you
                </S.Text>
                <S.Button bgHover="#414A44" fontHover="#F6F0DB" border="2px solid #414A44" padding="0.8rem 1rem">See more</S.Button>
              </S.Box>
            </S.Box>
          </S.Box>
        </S.Container>
        ...
        <S.Container>
          <S.Box gap="2rem" display="flex" wrap="wrap">
            ...
            <S.Box flex="1" mWidth="100%">
              ...
              <ul>
                <S.A size="0.9rem" margin="0.5px" decoration="none" decorationHover="underline" href="#"><li>Sales</li></S.A>
